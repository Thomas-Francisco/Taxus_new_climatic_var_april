...
```{r}
load("C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/outliers/outliers_set_final_overlapping_no_LD.Rdata")

outliers_set_final_overlapping_no_LD_df <- data.frame(outliers=outliers_set_final_overlapping_no_LD)
outliers_set_final_overlapping_no_LD_new_var_df <- data.frame(outliers=outliers_set_final_overlapping_no_LD_new_var)

#merge the two dataset

similar_outliers_df <- merge(outliers_set_final_overlapping_no_LD_df,outliers_set_final_overlapping_no_LD_new_var_df,"outliers")
