...
```{r load data}
#names of the files
list_data <- c("outliers_RDA_FDR5perc_T_Adapcon_gentree","outliers_pRDA_FDR5perc_T_Adapcon_gentree","outliers_T_adapcon_gentree_BAYPASS_BF_10","outliers_T_adapcon_gentree_LFMM_5perc","outliers_rank_based_top1perc_GF_raw","outliers_rank_based_top1perc_GF_corrected")
...
list_all_candidates_snps_MC <- data.frame(list_all_candidates_snps)
write_xlsx(list_all_candidates_snps_MC,path="C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA_new_var/outliers/set/list_all_candidates_snps_MC.xlsx") 
```
